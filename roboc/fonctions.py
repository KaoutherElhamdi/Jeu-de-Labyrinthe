...
def faire_le_mouvement(mvt,carte):
    ...
    if mvt[0].upper()=="N" :    nouvelle_position= position[0]-nb,position[1]
    if mvt[0].upper()=="S" :    nouvelle_position= position[0]+nb,position[1]
    if mvt[0].upper()=="E" :    nouvelle_position= position[0],position[1]+nb
    if mvt[0].upper()=="O" :    nouvelle_position= position[0],position[1]-nb
...
def partie_sauvegardee_ou_nouvelle():
    ...
    c=input("Cliquer sur (o ou O) : pour continuer à jouer la partie sauvegardée\nou cliquer sur (n ou N): pour commencer une nouvelle partie\n===>  ")
